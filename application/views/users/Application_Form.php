<div class="container px-4 py-2">
    ...
    <?php if (isset($user_data) && is_array($user_data) && !empty($user_data) && $user_data !== false) { ?>
        <form action="<?php echo base_url(); ?>sticker/apply/submit" method="post" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="col-4">
                ...
                <div class="col-4">
                    ...
                    <div class="form-group pb-2">
                        ...
                        <input type="date" class="form-control" placeholder="02/02/2020" name="tax_date" required>
                    </div>
                    <div class="form-group pb-2">
                        <small>Licence's Valid Date</small>
                        <input type="date" class="form-control" placeholder="20/04/2020" name="licence_date" required>
                    </div>
                    <div class="form-group pb-2">
